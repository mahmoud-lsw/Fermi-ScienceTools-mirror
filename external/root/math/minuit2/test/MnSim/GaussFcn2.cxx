// @(#)root/minuit2:$Id: GaussFcn2.cxx,v 1.1.1.1 2009/04/05 20:44:14 elwinter Exp $
...
double GaussFcn2::operator()(const std::vector<double>& par) const {
  ...
  for(int n = 0; n < nmeas; n++) {
    chi2 += ((gauss1(fPositions[n]) + gauss2(fPositions[n]) - fMeasurements[n])*(gauss1(fPositions[n]) + gauss2(fPositions[n]) - fMeasurements[n])/fMVariances[n]);
  }
