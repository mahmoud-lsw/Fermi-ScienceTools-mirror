...
/*
 * $Log: ape_msg.c,v $
 * Revision 1.8.10.1  2015/04/26 06:53:57  jasercio
 * Resync of ST_DEV branch rolling back Healpix and WCS changes while leaving ScienceTools-v10r0p4-slac-20150426 changes.
 *
 * Revision 1.10  2014/08/29 12:49:37  peachey
 * All functions to redirect warning and info streams, in parallel with
 * the redirect functions for output and error streams. Change unit test
 * and reference output to test the new functions.
 *
