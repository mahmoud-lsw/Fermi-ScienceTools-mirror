...
/*
 * $Log: ape_test.h,v $
 * Revision 1.11.8.1  2015/04/26 06:53:52  jasercio
 * Resync of ST_DEV branch rolling back Healpix and WCS changes while leaving ScienceTools-v10r0p4-slac-20150426 changes.
 *
 * Revision 1.12  2014/08/29 12:54:20  peachey
 * Add function to return status of unit test. Change unit test output to
 * match aht-style output to make test results more check-able.
 *
