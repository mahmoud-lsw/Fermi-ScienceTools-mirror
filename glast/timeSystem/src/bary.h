/* RCS: $Id: bary.h,v 1.1.1.1 2006/04/21 20:56:15 peachey Exp $ */
/*-----------------------------------------------------------------------
 *
 *  bary.h
 *
...
static enum Observatory {Unknown, Geocenter, XTE, AXAF, SWIFT, GLAST} mission=Unknown ;
...
double *swiftscorbit (char *, double, int *) ;       /* Swift-specific */
...
static long leapsMJD[200] ;
static double leapsecs[200] ;
static double MJDoffset[200] ;
static double leapcoeff[200] ;
char *bhrcsid = "RCS: $Id: bary.h,v 1.1.1.1 2006/04/21 20:56:15 peachey Exp $" ;
