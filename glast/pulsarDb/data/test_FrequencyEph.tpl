# Pulsar Ephemerides Database for tests of FrequencyEph class
...
EPHSTYLE     = 'FREQ'                      / name of pulsar ephemeris model
...
TTYPE6       = 'EPOCH_INT'                 / integer part of barycentric epoch (TDB) of RA, DEC, F0, F1, and F2 in MJD
TFORM6       = 'J'                         / data format of field: 4-byte signed INTEGER
TUNIT6       = 'd'                         / physical unit of field
TTYPE7       = 'EPOCH_FRAC'                / fractional part of barycentric epoch (TDB) of RA, DEC, F0, F1, and F2 in MJD
...
TTYPE13      = 'F1'                        / first time derivative of pulsar frequency
TFORM13      = 'D'                         / data format of field: 8-byte DOUBLE
TUNIT13      = 's**(-2)'                   / physical unit of field
TTYPE14      = 'F2'                        / second time derivative of pulsar frequency
