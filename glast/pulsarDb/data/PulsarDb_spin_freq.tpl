# Extension of Pulsar Ephemerides Database to store spin ephemerides of a simple frequency history model
...
TTYPE6       = 'EPOCH_INT'                 / integer part of the epoch for F0, F1, and F2 in MJD (TDB)
TFORM6       = 'J'                         / data format of field: 4-byte signed INTEGER
TUNIT6       = 'd'                         / physical unit of field
TTYPE7       = 'EPOCH_FRAC'                / fractional part of the epoch for F0, F1, and F2 in MJD (TDB)
