  ...
  class FrequencyEph : public PulsarEph {
    public:
      /** \brief Create a pulsar ephemeris object with the given parameters.
          ...
          \param f0 Pulse frequency in the units of s^(-1) at the given epoch.
          \param f1 First time derivative of pulse frequency in the units of s^(-2) at the given epoch.
          \param f2 Second time derivative of pulse frequency in the units of s^(-3) at the given epoch.
      */
