 ...
 * @author J. Chiang
 *
 * $Header: /nfs/slac/g/glast/ground/cvs/ScienceTools-scons/Likelihood/src/SourceModelBuilder.cxx,v 1.21 2015/03/03 21:41:31 jchiang Exp $
 */
...
DOMElement * SourceModelBuilder::spectralPart(Source & src) {
   ...
   if (scaleFactor != 0) {
      fileFunc = dynamic_cast<FileFunction *>(scaleFactor->spectrum());
   } else {
      fileFunc = dynamic_cast<FileFunction *>(srcFuncs["Spectrum"]);
   }
   if (fileFunc != 0) {
