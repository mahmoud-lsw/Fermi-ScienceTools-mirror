 ...
 * @author J. Chiang
 * 
 * $Header: /nfs/slac/g/glast/ground/cvs/ScienceTools-scons/Likelihood/src/test/test.cxx,v 1.130 2013/01/15 00:17:35 jchiang Exp $
 */
...
void LikelihoodTests::test_DiffRespNames() {
   ...
   foo.addColumn("P7REP_SOURCE_V15__Extragalactic Diffuse");
   foo.addColumn("P7REP_SOURCE_V15__GALPROP Diffuse");
   
   CPPUNIT_ASSERT("P7REP_SOURCE_V15__Extragalactic Diffuse" == foo[0]);
   CPPUNIT_ASSERT("P7REP_SOURCE_V15__Extragalactic Diffuse" == foo["DIFRSP0"]);
                 
   CPPUNIT_ASSERT("P7REP_SOURCE_V15__GALPROP Diffuse" == foo[1]);
   CPPUNIT_ASSERT("P7REP_SOURCE_V15__GALPROP Diffuse" == foo["DIFRSP1"]);

   CPPUNIT_ASSERT("DIFRSP0" == foo.key("P7REP_SOURCE_V15__Extragalactic Diffuse"));
   CPPUNIT_ASSERT("DIFRSP1" == foo.key("P7REP_SOURCE_V15__GALPROP Diffuse"));
