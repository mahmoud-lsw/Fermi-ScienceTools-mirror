...
# Modified so gtorbsim makes valid fits files, 09/2008
# And now named properly 04/2009
...
OBSERVER    = 'none'                      / Simulated data, no observer really
FILENAME    =                             / name of this file
ORIGIN      = 'FSSC'                      / name of organization making file
CREATOR     = 'gtorbsim $Name: ScienceTools-v10r0p5-fssc-20150518 $'         / software and version creating file
...
TFORM13      = 'E'                         / data format of field: 8-byte DOUBLE
...
TFORM15      = 'E'                         / data format of field: 8-byte DOUBLE
...
TTYPE20      = 'LAT_MODE'                  / operation mode of LAT
