 ...
 * @author J. Chiang
 *
 * $Header: /nfs/slac/g/glast/ground/cvs/ScienceTools-scons/irfs/dc1aResponse/src/loadIrfs.cxx,v 1.2 2007/01/20 20:31:10 jchiang Exp $
 */
...
void load_irfs() {
   ...
   try {
      ...
      myFactory->addIrfs("DC1A2::Front",
                         new irfInterface::Irfs(aeff2, psf->clone(),
                                                edisp->clone(), 0));
