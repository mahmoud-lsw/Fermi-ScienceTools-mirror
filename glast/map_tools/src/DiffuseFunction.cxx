...
$Header: /nfs/slac/g/glast/ground/cvs/ScienceTools-scons/map_tools/src/DiffuseFunction.cxx,v 1.1 2007/05/07 18:31:59 burnett Exp $
*/

#include "map_tools/DiffuseFunction.h"
#include <cmath>
...
double DiffuseFunction::extraGal(double energy)const
{
    ...
    double flux(m_egal_flux), alpha(m_egal_index-1);
...
void DiffuseFunction::setEnergy(double e)
{
    static double log2(log(2.0));
    m_energy = e;
    double step ( log(e/s_emin)/log2 );
...
double DiffuseFunction::operator ()(double energy){
    this->setEnergy(energy);
    return operator()(m_dir);
}
