...
if module_exists('root'):
    _plotter_package = 'root'
    print "Plotter is root"
elif module_exists('hippoplotter'):
     _plotter_package = 'HippoPlot'
     print "Plotter is HippoPlot"
elif module_exists('MPLPlot'):
     _plotter_package = 'mpl'
     print "Plotter is MatPlotlib"
else:
    raise ImportError('Plotting requires root, HippoDraw, or MatPlotLib')
...
class AnalysisBase(object):
    ...
    def setPlotter(self, plotter='hippo'):
        ...
        if plotter == 'hippo':
            ...
            return plot
    def setPlotter(self, plotter='mpl'):
        global _plotter_package
        _plotter_package = plotter
        if plotter == 'mplplot':
            import MPLPlot as plot
            return plot
    def __call__(self):
        ...
        try:
            if _plotter_package == 'root':
                try:
                	...
                	print "Failed importing Root.  Defaulting to HippoPlot."
                	try:
				print('try to import HippoPlot')
                		from HippoPlot import HippoPlot
				print('after try to import HippoPlot')
