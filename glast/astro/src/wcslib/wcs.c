...
*   $Id: wcs.c,v 1.3 2005/10/20 16:08:37 hierath Exp $
*===========================================================================*/
...
{
   char *c, ctypei[16];
   int  axis, cubeface, dealloc, dummy, i, itab, j, k, latitude, longitude,
        m, *map = 0x0, msub, naxis, npv, nps, other, spectral, status, stokes;
   const double *srcp;
   double *dstp;
   struct tabprm *tabp;
...

{
   ...
   if (wcs->flag == -1) {
      ...
      /* Free memory allocated by wcsset2(). */
