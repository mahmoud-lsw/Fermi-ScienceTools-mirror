...
*   $Id: wcshdr.h,v 1.2 2008/08/22 22:18:47 elwinter Exp $
*=============================================================================
*
...
*         the prologue of getwcstab.h.  wcsset2() will automatically take
...
*
*      5: Initialize wcsprm struct(s) using wcsset2() and calculate coordinates
...
*                        that wcsset2() is not invoked on these structs.
*
...
*   wcsset2() will automatically take control of this allocated memory, in
*   particular causing it to be free'd by wcsfree(); the user must not attempt
*   to free it after wcsset2() has been called.
*
