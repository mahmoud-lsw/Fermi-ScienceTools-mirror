...
*   $Id: wcsfix.h,v 1.1 2005/10/20 16:08:38 hierath Exp $
*=============================================================================
*
...
*      fly by wcsset2() but without modifying the relevant ctype[], pv[] or
*      specsys members of the wcsprm struct.  That is, only the information
*      extracted from ctype[] is translated when wcsset2() fills in the prj
...
*      and translated to pc[][] by wcsset2().  These are not dealt with here,
